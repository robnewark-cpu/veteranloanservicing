...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": ${JSON.stringify(page.sectionLabel || "Resources")}, "item": "https://veteranloanservicing.com/${page.sectionSlug || "resources"}" },
  ...
  <section class="hero" style="padding-bottom:20px;" aria-labelledby="resource-hero">
    <div class="container" style="max-width:820px;">
      <div class="breadcrumb">
        <a href="/">Home</a><span>/</span><a href="/${page.sectionSlug || "resources"}">${esc(page.sectionLabel || "Resources")}</a><span>/</span><span aria-current="page">${esc(page.navLabel)}</span>
      </div>
...
function renderDir(dir, label) {
  ...
  for (const file of files) {
    ...
    console.log(`✓ ${page.slug}.html  [${label}]`);
  }
  return files.length;
}
